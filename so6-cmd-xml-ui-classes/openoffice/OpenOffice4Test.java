 ...
 * @author tani
 */
public class OpenOffice4Test extends TestCase {
    // Parcours guid� pour l'utilisation de Writer
    ...
    public OpenOffice4Test(String arg0) {
        super(arg0);
    }
    ...
    public void testContentFile4() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file4" + File.separator + "content.xml";
    ...
    public void testManifestFile4() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file4" + File.separator + "manifest.xml";
    ...
    public void testMetaFile4() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file4" + File.separator + "meta.xml";
    ...
    public void testSettingsFile4() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file4" + File.separator + "settings.xml";
    ...
    public void testStylesFile4() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file4" + File.separator + "styles.xml";
