...
public class DeleteAttribute extends UpdateXmlFile {
    ...
    public DeleteAttribute(long ticket, String path, String wsName, long time, String nodePath, String attrName) {
        super(ticket, path, wsName, time, false, null);
        this.nodePath = nodePath;
        this.attrName = attrName;
    }

    public DeleteAttribute(String path, WsConnection ws, String nodePath, String attrName) {
        super(path, ws);
        this.nodePath = nodePath;
        this.attrName = attrName;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DeleteAttribute) {
            return path.equals(((DeleteAttribute) obj).path) && nodePath.equals(((DeleteAttribute) obj).nodePath) &&
            ((DeleteAttribute) obj).attrName.equals(attrName);
        } else {
            return false;
        }
    }
    ...
    public void doTheJobOnFile(String xmlFilePath) throws IOException, InvalidNodePath, ParseException, AttributeNotAllowed {
        XmlUtil.deleteAttribute(xmlFilePath, nodePath, attrName);
    }

    public String toString() {
        return "DeleteAttribute(" + nodePath + "," + attrName + ")";
    }
