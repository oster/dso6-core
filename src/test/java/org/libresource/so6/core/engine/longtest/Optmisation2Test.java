...
public class Optmisation2Test extends TestCase {
    ...
    public Optmisation2Test(String name) {
        super(name);
    }
    ...
    public void testWithoutSubTree() throws Exception {
        // create 50 files in replica1-2
        for (int i = 0; i < 50; i++) {
            FileUtils.createTxtFile(dir1, "file1_" + i + ".txto", "some content1");
            FileUtils.createTxtFile(dir2, "file1_" + i + ".txto", "some content2");
        }
