 ...
 * @author tani
 */
public class OpenOffice2Test extends TestCase {
    ...
    public OpenOffice2Test(String arg0) {
        super(arg0);
    }
    ...
    public void testContentFile2() throws Exception {
        // Out of memory Exception
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file2" + File.separator + "content.xml";
    ...
    public void testManifestFile2() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file2" + File.separator + "manifest.xml";
    ...
    public void testMetaFile2() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file2" + File.separator + "meta.xml";
    ...
    public void testSettingsFile2() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file2" + File.separator + "settings.xml";
    ...
    public void testStylesFile2() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file2" + File.separator + "styles.xml";
