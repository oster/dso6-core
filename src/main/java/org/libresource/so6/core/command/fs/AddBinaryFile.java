...
public class AddBinaryFile extends AddFile {
    private static final long serialVersionUID = 3;

    public AddBinaryFile(long ticket, String path, String wsName, long time, boolean conflict, String attachement) {
        super(ticket, path, wsName, time, conflict, attachement);
    }

    public AddBinaryFile(String path, WsConnection ws) {
        super(path, ws);
    ...
    public AddBinaryFile(String path, WsConnection ws, String attachement) {
        super(path, ws);
        this.setAttachement(attachement);
    }

    public AddBinaryFile(String path, WsConnection ws, File tmpDestDir) {
        super(path, ws);
	...
	public void execute(String dir, DBType dbt) throws Exception {
         ...
         */
        dbt.add(path, DBType.TYPE_FILE_BIN);
    }
}
