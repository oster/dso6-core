 ...
 * @author tani
 */
public class OpenOffice1Test extends TestCase {
    ...
    public OpenOffice1Test(String arg0) {
        super(arg0);
    }
    ...
    public void testContentFile1() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file1" + File.separator + "content.xml";
    ...
    public void testManifestFile1() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file1" + File.separator + "manifest.xml";
    ...
    public void testMetaFile1() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file1" + File.separator + "meta.xml";
    ...
    public void testSettingsFile1() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file1" + File.separator + "settings.xml";
    ...
    public void testStylesFile1() throws Exception {
        assertTrue("Dir1 <> Dir2", FileUtils.compareDir(dir1, dir2));
        path = baseDir + File.separator + "file1" + File.separator + "styles.xml";
